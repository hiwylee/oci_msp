...
| `REGIONS` | 조회할 리전 목록 (예: `("ap-seoul-1" "us-chicago-1")`) |
| `COMPARTMENT_ID` | 기본 Compartment OCID |
| `TENANCY_ID` | Tenancy OCID (`compartments` 명령에 필요) |
...
├── lib/
│   ├── common.sh        # log · retry · print_table 유틸
